...
namespace FigureWindowsForms
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this._buttonRandomList = new System.Windows.Forms.Button();
			...
			this._groupBoxButton.Controls.Add(this._buttonRandomList);
			...
			this._groupBoxButton.Name = "groupBoxButton";
			...
			this._buttonDeleteList.Name = "buttonDeleteList";
			...
			this._buttonResertFilter.Name = "buttonResertFilter";
			...
			// buttonRandomList
			// 
			this._buttonRandomList.Location = new System.Drawing.Point(549, 14);
			this._buttonRandomList.Name = "buttonRandomList";
			this._buttonRandomList.Size = new System.Drawing.Size(221, 31);
			this._buttonRandomList.TabIndex = 2;
			this._buttonRandomList.Text = "Случайный список";
			this._buttonRandomList.UseVisualStyleBackColor = true;
			this._buttonRandomList.Click += new System.EventHandler(this.ButtonRandomListClick);
			// 
			// buttonFilter
			// 
			...
			this._toolStripDropDownButton1.Image = ((System.Drawing.Image)(resources.GetObject("toolStripDropDownButton1.Image")));
			this._toolStripDropDownButton1.ImageTransparentColor = System.Drawing.Color.Magenta;
			this._toolStripDropDownButton1.Name = "toolStripDropDownButton1";
		...
		private Button _buttonRandomList;
